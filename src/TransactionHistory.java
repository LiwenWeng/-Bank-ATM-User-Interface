...
public class TransactionHistory {
    ...
    public void updateAccountTransactions(String action, String isSuccess, String currentBalance) {
        accountTransactions.add(new String[]{"A" + formatId(accountTransactions.size()), action, isSuccess, currentBalance});
    }

    public void updateSecurityTransactions(String action, String isSuccess) {
        securityTransactions.add(new String[]{"S" + formatId(securityTransactions.size()), action, isSuccess});
    }
